...
const articleList = async () => {
    ...
    articles.value = result.data.pages;
...
<template>
    <el-card class="page-container">
            ...
            <div class="header">
                ...
                <div class="extra">
                    <el-button type="primary"
                        @click="visibleDrawer = true; title = '添加文章'; articleModel = { title: '', categoryId: '', coverImg: '', content: '', state: '' }">添加文章</el-button>
                </div>
            </div>
        </template>
        <!-- 搜索表单 -->
        ...
        <!-- 文章列表 -->
        <el-table :data="articles" style="width: 100%" stripe :header-cell-style="{ background: '#f5f7fa', color: '#333', fontWeight: 'bold' }">
            ...
            <el-form :model="articleModel" label-width="100px">
                ...
                <el-form-item label="文章封面">
                    ...
                    <el-upload class="avatar-uploader" :auto-upload="true" :show-file-list="false"
                        action="/api/article/upload" name="upfile" :headers="{ 'Authorization': tokenStore.token }"
...
.page-container {
    ...
    box-shadow: 0 8px 24px rgba(0, 0, 0, 0.08) !important; /* 更明显的投影 */
